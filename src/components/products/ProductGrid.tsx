...
import { motion } from 'framer-motion';
 import { products } from '@/lib/data2';
import { isCategory, getProductsByCategory } from '@/lib/queries';
  ...
  'skincare': [
    {
      ...
      rating: 4.5,
      reviews: 128,
      image: "https://images.pexels.com/photos/5069606/pexels-photo-5069606.jpeg?auto=compress&cs=tinysrgb&w=600"
    },
    {
      id: 2,
...
export default function ProductGrid({ categorySlug }: ProductGridProps) {
  ...
  const productByCategory = isCategory(categorySlug) ? getProductsByCategory(categorySlug, products) : [];
